...
export const INTRO_TEXT =
    "In this experiment, you will be asked two questions about how you perceive and judge the world around you. " +
    "Each question presents a short piece of background information followed by a statement. For each statement, " +
    "you will indicate how strongly you agree or disagree by clicking on a response bar. There are no right or wrong " +
    "answers — we are interested in your honest opinion. The survey should take only a couple of minutes.";

// TODO: replace with the real Prolific completion URL / code for this study.
export const END_SCREEN_URL = "https://app.prolific.com/submissions/complete?cc=CHANGE_ME";
