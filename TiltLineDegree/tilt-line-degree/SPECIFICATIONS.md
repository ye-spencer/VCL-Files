...
In each trial, the screen will start blank. There will be one rectangle in the middle of the screen. The rectangle will appear for a brief second, then disappear. Then the participant will click either q or p to indicate which way the rectangle was tilted. The rectangle should have a certain ratio of length, which reach ration repeated a constant number of times.
